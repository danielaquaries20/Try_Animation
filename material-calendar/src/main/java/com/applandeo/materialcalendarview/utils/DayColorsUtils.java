...
public class DayColorsUtils {
    ...
    public static void setCurrentMonthDayColors(Calendar day, Calendar today, TextView dayLabel,
        ...
        if (today.equals(day)) {
            int sunday= day.get(Calendar.DAY_OF_WEEK);
            if (sunday == Calendar.SUNDAY) {
                setDayColors(dayLabel, calendarProperties.getSundayColor(), Typeface.BOLD,
            ...
            if (sunday == Calendar.SUNDAY) {
                EventDayUtils.getEventDayWithLabelColor(day, calendarProperties).executeIfPresent(eventDay ->
                        DayColorsUtils.setDayColors(dayLabel, calendarProperties.getSundayColor(),
            ...
            int sunday= day.get(Calendar.DAY_OF_WEEK);
            if (sunday == Calendar.SUNDAY) {
                setDayColors(dayLabel, calendarProperties.getSundayColor(),
                        Typeface.NORMAL, R.drawable.background_transparent);
            } else {
            ...
            int sunday= day.get(Calendar.DAY_OF_WEEK);
            if (sunday == Calendar.SUNDAY) {
                setDayColors(dayLabel, calendarProperties.getSundayColor(), Typeface.NORMAL,
                        R.drawable.background_transparent);
            } else {
