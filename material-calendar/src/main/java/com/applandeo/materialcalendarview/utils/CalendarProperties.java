...
public class CalendarProperties {
    ...
    private OnSelectTodayListener mOnSelectTodayListener;
    ...
    public OnSelectTodayListener getOnTodayListener() {
        return mOnSelectTodayListener;
    }

    public void setOnTodayListener(OnSelectTodayListener onSelectTodayListener) {
        mOnSelectTodayListener = onSelectTodayListener;
    }
