...
import com.applandeo.materialcalendarview.listeners.OnSelectTodayListener;
...
public class CalendarView extends LinearLayout {
    ...
    private void initUiElements() {
        ...
        mCurrentMonth = findViewById(R.id.currentDateMonth);
        mCurrentYear = findViewById(R.id.currentDateYear);

        TextView today = findViewById(R.id.btnToday);
        today.setOnClickListener(v -> showCurrentMonthPage());

        ImageView btnCalendar = findViewById(R.id.btnCalendar);
        ImageView btnList = findViewById(R.id.btnList);

        btnList.setOnClickListener(v -> mCalendarProperties.getOnTodayListener().onSelect());
    ...
    public void setOnTodayListener(OnSelectTodayListener listener) {
        mCalendarProperties.setOnTodayListener(listener);
    }
    ...
    private final ViewPager.OnPageChangeListener onPageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            mCalendarProperties.refreshEventDays();
        }
    ...
    private void setHeaderName(Calendar calendar, int position) {
        mCurrentMonth.setText(DateUtils.getMonth(mContext, calendar));
        mCurrentYear.setText(DateUtils.getYear(calendar));
    ...
    public void setDate(Calendar date) throws OutOfDateRangeException {
        ...
        mCurrentMonth.setText(DateUtils.getMonth(mContext, date));
        mCurrentYear.setText(DateUtils.getYear(date));
    ...
    public void setEvents(List<EventDay> eventDays) {
        ...
        if (mCalendarProperties.getEventsEnabled()) {
            mCalendarProperties.setEventDays(this.eventDays);
            mCalendarPageAdapter.notifyDataSetChanged(mCalendarProperties, mCurrentPage);
        }
    }
    ...
    public void setSundays(List<Calendar> highlightedDays) {
        mCalendarProperties.setHighlightedDays(highlightedDays);
    }
