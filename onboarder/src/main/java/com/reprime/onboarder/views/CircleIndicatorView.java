package com.reprime.onboarder.views;
...
import com.reprime.onboarder.R;
...
public class CircleIndicatorView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < indicatorsCount; i++) {
            canvas.drawCircle(radius + (size * i), radius, radius / 1.8f, inactiveIndicatorPaint);
        }
        canvas.drawCircle(radius + (size * position), radius, radius / 1.8f, activeIndicatorPaint);
    }
