...
public abstract class AhoyOnboarderActivity extends AppCompatActivity implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    private void setContentText(int position) {
        tvTitle.setText(pages.get(position).getTitle());
        tvDesc.setText(pages.get(position).getDescription());
    }
    ...
    public void onClick(View v) {
        ...
        } else if (i == R.id.btn_next && !isInLastPage) {
