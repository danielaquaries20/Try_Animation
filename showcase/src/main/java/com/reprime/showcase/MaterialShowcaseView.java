...
import com.reprime.showcase.shape.CircleShape;
import com.reprime.showcase.shape.NoShape;
import com.reprime.showcase.shape.RectangleShape;
import com.reprime.showcase.shape.Shape;
import com.reprime.showcase.target.Target;
import com.reprime.showcase.target.ViewTarget;
...
public class MaterialShowcaseView extends FrameLayout implements View.OnTouchListener, View.OnClickListener {
    ...
    private ImageView arrowLeftUp;
    private ImageView arrowLeftDown;
    private ImageView arrowRightUp;
    private ImageView arrowRightDown;

    private LinearLayout vButton;
    ...
    private boolean mIsArrow = true;
    private boolean mIsGreeting = false;
    private boolean mShowTapAnywhere = false;
    ...
    private void init(Context context) {
        ...
        //mIvImage = contentView.findViewById(R.id.iv_image);
        mContentTextView = contentView.findViewById(R.id.tv_content);
        mContentImageView = contentView.findViewById(R.id.tv_content_img);
        mDismissButton = contentView.findViewById(R.id.tv_dismiss);

        vButton = contentView.findViewById(R.id.v_button);
        btnSkip = contentView.findViewById(R.id.btn_skip);
        btnNext = contentView.findViewById(R.id.btn_next);

        arrowUp = contentView.findViewById(R.id.arrow_up);
        arrowDown = contentView.findViewById(R.id.arrow_down);
        arrowLeftUp = contentView.findViewById(R.id.arrow_left_up);
        arrowLeftDown = contentView.findViewById(R.id.arrow_left_down);
        arrowRightUp = contentView.findViewById(R.id.arrow_right_up);
        arrowRightDown = contentView.findViewById(R.id.arrow_right_down);
    ...
    private void resetArrow() {
        ...
        arrowLeftUp.setVisibility(View.GONE);
        arrowLeftDown.setVisibility(View.GONE);
        arrowRightUp.setVisibility(View.GONE);
        arrowRightDown.setVisibility(View.GONE);
        mContentTextView.setGravity(Gravity.LEFT);
        vButton.setGravity(Gravity.LEFT);
    }
    ...
    private static int toPx(int dp, Context context) {
        return (int) (dp * context.getResources().getDisplayMetrics().density);
    }

    private void addAnywhere() {

        LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT);
        lp.gravity = Gravity.CENTER;
        lp.bottomMargin = toPx(16, getContext());

        ImageView iv = new ImageView(getContext());
        iv.setImageResource(R.drawable.ic_tap_anywhere);
        iv.setLayoutParams(lp);

        LinearLayout.LayoutParams lp1 = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT);
        lp1.gravity = Gravity.CENTER;
        lp1.bottomMargin = toPx(56, getContext());

        TextView tv = new TextView(getContext());
        tv.setText("Tap anywhere to next");
    ...
    private void notifyOnDismissed() {
        ...
        if (mDetachedListener != null) {
            mDetachedListener.onShowcaseDetached(this, mWasDismissed, mSkip);
        }
    }
    ...
    public void setTarget(Target target) {
        ...
        if (mTarget != null) {
            ...
            int wPoint1 = width / 3;
            int wPoint2 = wPoint1 * 2;

            //int wTarget = targetBounds.right - targetBounds.left;

            int pos = 0;

            if (xPos > wPoint2) {
                pos = 2;
            } else if (xPos > wPoint1) {
                pos = 1;
            }

            /*Log.d("CASE", "p -> " + wPoint1);
            Log.d("CASE", "p2 -> " + wPoint2);
            Log.d("CASE", "x -> " + xPos);*/


            /*Log.d("CASE", "w -> " + width);
            Log.d("CASE", "x -> " + xPos);
            Log.d("CASE", "wt -> " + wTarget);
            Log.d("CASE", "l -> " + targetBounds.left);*/

            /*LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(-2, -2);
            lp.gravity = xGravity;
            btmArrow.setLayoutParams(lp);*/
            ...
            if (yPos > midPoint) {
                ...
                mContentTextView.setPadding(0, 0, 32, 0);
                mContentTextView.setGravity(Gravity.LEFT);
                ...
                if (!mIsGreeting) {
                    if (pos == 0) {
                        ...
                        vButton.setGravity(Gravity.LEFT);
                        if (mIsArrow) {
                            arrowLeftDown.setVisibility(View.VISIBLE);
                            arrowLeftUp.setVisibility(View.INVISIBLE);
                        }
                    } else if (pos == 1) {
                        mContentTextView.setGravity(Gravity.CENTER);
                        vButton.setGravity(Gravity.CENTER);
                        if (mIsArrow) {
                            arrowDown.setVisibility(View.VISIBLE);
                        }
                    } else {
                        mContentTextView.setPadding(32, 0, 0, 0);
                        mContentTextView.setGravity(Gravity.RIGHT);
                        vButton.setGravity(Gravity.RIGHT);
                        if (mIsArrow) {
                            arrowRightDown.setVisibility(View.VISIBLE);
                            arrowRightUp.setVisibility(View.INVISIBLE);
                        }
                    }
                }
            } else {
                ...
                if (!mIsGreeting) {
                    if (pos == 0) {
                        ...
                        vButton.setGravity(Gravity.LEFT);
                        if (mIsArrow) {
                            arrowLeftUp.setVisibility(View.VISIBLE);
                            arrowLeftDown.setVisibility(View.INVISIBLE);
                        }
                    } else if (pos == 1) {
                        mContentTextView.setGravity(Gravity.CENTER);
                        vButton.setGravity(Gravity.CENTER);
                        ...
                        vButton.setGravity(Gravity.RIGHT);
                        if (mIsArrow) {
                            arrowRightUp.setVisibility(View.VISIBLE);
                            arrowRightDown.setVisibility(View.INVISIBLE);
                        }
                    }
                }
            }
    ...
    private void setImgContentText(CharSequence contentText) { //int imgRes
        if (mContentImageView != null) {
            mContentImageView.setText(contentText);
    ...
    private void setButtonText(CharSequence buttonText) {
        if (btnNext != null && !buttonText.equals("")) {
    ...
    private void setButtonText(CharSequence buttonText, CharSequence buttonText2) {
        if (btnSkip != null && !buttonText.equals("")) {
            vButton.setVisibility(View.VISIBLE);
            btnSkip.setVisibility(View.VISIBLE);
            btnSkip.setText(buttonText);
        }

        if (btnNext != null && !buttonText2.equals("")) {
            vButton.setVisibility(View.VISIBLE);
            btnNext.setVisibility(View.VISIBLE);
            btnNext.setText(buttonText2);
        }
    }
    ...
    private void setShowTapAnywhere(boolean showTapAnywhere) {
        mShowTapAnywhere = showTapAnywhere;
    }

    private void setIsGreeting(boolean isGreeting) {
        mIsGreeting = isGreeting;
    }

    private void setIsArrow(boolean isArrow) {
        mIsArrow = isArrow;
    }
    ...
    public static class Builder {
        ...
        public Builder setImgContentText(CharSequence text) { //int imgRes
            showcaseView.setImgContentText(text); //imgRes
            return this;
        }
        ...
        public Builder setButtonText(CharSequence buttonText, CharSequence buttonText2) {
            showcaseView.setButtonText(buttonText, buttonText2);
            return this;
        }
        ...
        public Builder setShowTapAnywhere(boolean showTapAnywhere) {
            showcaseView.setShowTapAnywhere(showTapAnywhere);
            return this;
        }

        public Builder setIsGreeting(boolean isGreeting) {
            showcaseView.setIsGreeting(isGreeting);
            return this;
        }

        public Builder setIsArrow(boolean isArrow) {
            showcaseView.setIsArrow(isArrow);
            return this;
        }
        ...
        public MaterialShowcaseView build() {
            ...
            FrameLayout.LayoutParams lp = new FrameLayout.LayoutParams(dm.widthPixels, dm.heightPixels + toPx(56, activity.getApplicationContext()));
            showcaseView.setLayoutParams(lp);*/
    ...
    public boolean show(final Activity activity) {
        ...
        /*if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
            WindowManager.LayoutParams attrib = activity.getWindow().getAttributes();
