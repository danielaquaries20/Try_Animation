...
public class MaterialShowcaseSequence implements IDetachedListener {
    ...
    @Override
    public void onShowcaseDetached(MaterialShowcaseView showcaseView, boolean wasDismissed, boolean skip) {
        ...
        if (wasDismissed) {
            ...
            if (mOnItemDismissedListener != null) {
                mOnItemDismissedListener.onDismiss(showcaseView, mSequencePosition, skip);
            }
    ...
    public interface OnSequenceItemDismissedListener {
        void onDismiss(MaterialShowcaseView itemView, int position, boolean skip);
    }
