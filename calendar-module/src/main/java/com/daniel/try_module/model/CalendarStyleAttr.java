package com.daniel.try_module.model;
...
public class CalendarStyleAttr {
    ...
    private boolean enabledDisableDate = false;
    ...
    public boolean isEnabledDisableDate() {
        return enabledDisableDate;
    }

    public void setEnabledDisableDate(boolean enabledDisableDate) {
        this.enabledDisableDate = enabledDisableDate;
    }
