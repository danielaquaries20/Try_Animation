package com.daniel.try_module.customviews;
...
import com.daniel.try_module.R;
import com.daniel.try_module.model.CalendarStyleAttr;
import com.daniel.try_module.model.DayContainer;
import com.daniel.try_module.timepicker.AwesomeTimePickerDialog;
...
public class DateRangeMonthView extends LinearLayout {
    ...
    private void drawDayContainer(DayContainer container, Calendar calendar) {
        ...
        } else if (calendarStyleAttr.isEnabledDisableDate() && calendar.before(calendarStyleAttr.getMinDate())) {
            Log.e("awsome-calendar", "day : " + calendar.get(Calendar.DATE) + " " + calendar.get(Calendar.MONTH) + " " + calendar.get(Calendar.YEAR));
            Log.e("awsome-calendar", "min : " + calendarStyleAttr.getMinDate().get(Calendar.DATE) + " " + calendarStyleAttr.getMinDate().get(Calendar.MONTH) + " " + calendarStyleAttr.getMinDate().get(Calendar.YEAR));
            disableDayContainer(container);
            container.tvDate.setText(String.valueOf(date));
        } else if (calendarStyleAttr.isEnabledDisableDate() && calendar.after(calendarStyleAttr.getMaxDate())) {
            Log.e("awsome-calendar", "day : " + calendar.get(Calendar.DATE) + " " + calendar.get(Calendar.MONTH) + " " + calendar.get(Calendar.YEAR));
            Log.e("awsome-calendar", "max : " + calendarStyleAttr.getMaxDate().get(Calendar.DATE) + " " + calendarStyleAttr.getMaxDate().get(Calendar.MONTH) + " " + calendarStyleAttr.getMaxDate().get(Calendar.YEAR));
            disableDayContainer(container);
            container.tvDate.setText(String.valueOf(date));
        } else {
